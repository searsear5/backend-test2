...
app.get("/interest",async(req:Request,res:Response)=> {
  try {
...
app.get("/guild",async(req:Request,res:Response)=> {
  try {
...
app.put("/editinfo", async (req: Request, res: Response) => {
  try {
    const {
      address,
      subdistrict,
...
//POST method
app.post("/addEducation", async (req: Request, res: Response) => {
  try {
    const {
      year,
      university
...
app.post("/addExperience", async (req: Request, res: Response) => {
  try {
    const {
      experience
    } = req.body; 
...
app.post("/addSkill", async (req: Request, res: Response) => {
  try {
    const {
      skill,
      skilllevel
...
app.post("/addinterests", async (req: Request, res: Response) => {
  try {
    const {
      interest
    } = req.body; 
...
app.post("/addguild", async (req: Request, res: Response) => {
  try {
    const {
      guild
    } = req.body; 
...
//DELETE method
app.delete("/exp/:id", async (req: Request, res: Response) => {
  const { id } = req.params;
  try {
...
app.delete("/interest/:id", async (req: Request, res: Response) => {
  const { id } = req.params;
  try {
...
app.delete("/guild/:id", async (req: Request, res: Response) => {
  const { id } = req.params;
  try {
